  ...
  return (
    ...
    >
      <div
        className={twMerge(
          scrollPos > 100 &&
            "absolute h-full w-screen top-0 left-1/2 -translate-x-1/2 bg-gradient-to-b from-black/70 to-transparent pointer-events-none"
        )}
      />

      <div
        className={twMerge("my-auto gap-5 justify-self-end hidden sm:block")}
      >
        <Link href="/home">
