...
export default function Navbar() {
  ...
  return (
    <nav className="grid p-8 max-w-screen-2xl mx-auto md:grid-cols-2 lg:grid-cols-3 ">
      ...
      <div className={twMerge(!isOpen && "hidden", "mb-7 md:hidden lg:block")}>
      ...
      <div className={twMerge(!isOpen && "hidden", "md:block")}>
        <ul className="flex items-center justify-center md:justify-end gap-5">
