...
function displayCountdownUntilDateTime(date: string, time: string) {
  ...
  return (
    <div className="font-mono text-xl grid grid-flow-col space-x-5 justify-center items-center">
      <div className="text-center">
        {days} <Text className="text-sm text-gray-300">Days</Text>
      </div>
      <p>{"|"}</p>
      <div className="text-center">
        {hours} <Text className="text-sm text-gray-300">Hours</Text>
      </div>
      <p>{"|"}</p>
      <div className="text-center">
        {minutes} <Text className="text-sm text-gray-300">Minutes</Text>
      </div>
    </div>
  );
}
