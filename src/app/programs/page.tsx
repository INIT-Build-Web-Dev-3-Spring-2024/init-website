...
const programs: Record<string, Omit<AboutProgramProps, 'name'>> = {
  Explore: {
    ...
    images: ['/images/programCards/explore/exploreOne.webp', '/images/programCards/explore/exploreTwo.webp'],
  },
  Reach: {
    ...
    images: ['/images/programCards/reach/reachOne.webp', '/images/programCards/reach/reachTwo.webp'],
  },
  Build: {
    ...
    images: ['/images/programCards/build/buildOne.webp', '/images/programCards/build/buildTwo.webp'],
  },
  Hack: {
    ...
    images: ['/images/programCards/hack/hackOne.webp', '/images/programCards/hack/hackTwo.webp'],
  },
  Ignite: {
    ...
    images: ['/images/programCards/ignite/igniteOne.webp', '/images/programCards/ignite/igniteTwo.webp'],
  },
  Uplift: {
    ...
    images: ['/images/programCards/uplift/upliftOne.webp', '/images/programCards/uplift/upliftTwo.webp'],
  },
}
...
export default function ProgramsPage() {
  ...
  function pickView() {
    switch (currentProgram) {
      ...
      default:
        return <AboutProgram {...programs[currentProgram]} name={currentProgram} />
    }
  }
